...
2. I then created the model and then put the new refined dataset to get the best results.
  ...
  - 3rd: I then split the data into categorical and numerical and scaled the numerical columns and encoded the categorical columns so the
    model can understand those categories and not skew the numerical ones.
